 ...
 * between miracled, and miracle-qt and non-server tools.
*/
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), MIRACLE_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Miracle/Miracle>";
    const std::string URL_WEBSITE = "<https://miraclecity.io>";
...
/** Sanity checks
 *  Ensure that Miracle is running in a usable environment with all
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", MIRACLE_CONF_FILENAME)).string());
