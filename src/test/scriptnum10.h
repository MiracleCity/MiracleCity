...
#ifndef MIRACLE_TEST_SCRIPTNUM10_H
#define MIRACLE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Miracle Core 0.10.0, for cross-comparison.
 */
public:
