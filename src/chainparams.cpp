...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 1051920;
        ...
        const char* pszTimestamp = "ALMA Detects Volcanic Gases in Atmosphere of Io | Apr 7, 2021 Sci News";

        genesis = CreateGenesisBlock(pszTimestamp, 1617910451, 957, 0x1f3fffff, 1, 0);
        consensus.hashGenesisBlock = genesis.GetBlockHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00248d4ce716cd664b618e7bd66e8f2147d9369be231f21d49d0c2d8e673c009"));
        assert(genesis.hashMerkleRoot == uint256S("0x2262782448d6abcc489d825ad939a929fb5963cfb54c8376055bc8220f9518cd"));
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the Miracle chain
        ...
        /** TOKENS START **/
        // Fee Amounts
        nFeeAmountMain = 10000000 * COIN;
        nFeeAmountSecondary = 10000000 * COIN;

        // Fee Addresse
        strTokenFeeAddress = "MgCcHzYzAey4hMoB3QxHRi9Mx2hGJUDS8t";
