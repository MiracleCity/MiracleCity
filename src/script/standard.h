...
#ifndef MIRACLE_SCRIPT_STANDARD_H
#define MIRACLE_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a miracle address
 */
...
/**
 * Generate a Miracle scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // MIRACLE_SCRIPT_STANDARD_H
