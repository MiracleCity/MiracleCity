...
#include "qt/miracleamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<MiracleAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_miracle-qt -platform xcb      # Linux
//     src/qt/test/test_miracle-qt -platform windows  # Windows
//     src/qt/test/test_miracle-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = MiracleUnits::formatWithUnit(unit, balance, false, MiracleUnits::separatorAlways);
    ...
    // Amount input
    MiracleAmountField* amountInput = receiveCoinsDialog.findChild<MiracleAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: miracle:")) != -1);
