...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    l2->setText(MiracleUnits::formatWithUnit(nDisplayUnit, nAmount));        // Amount
    ...
    l8->setText(MiracleUnits::formatWithUnit(nDisplayUnit, nChange));        // Change
    if (nPayFee > 0)
    {
...
void CoinControlDialog::updateView()
{
    ...
    for (const std::pair<QString, std::vector<COutput>>& coins : mapCoins) {
        ...
        for (const COutput& out : coins.second) {
            ...
            // amount
            itemOutput->setText(COLUMN_AMOUNT, MiracleUnits::format(nDisplayUnit, out.tx->tx->vout[out.i].nValue));
