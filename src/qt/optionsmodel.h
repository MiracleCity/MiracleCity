...
#ifndef MIRACLE_QT_OPTIONSMODEL_H
#define MIRACLE_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Miracle client.
...
#endif // MIRACLE_QT_OPTIONSMODEL_H
