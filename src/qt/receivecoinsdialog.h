...
#ifndef MIRACLE_QT_RECEIVECOINSDIALOG_H
#define MIRACLE_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of MCAM */
...
#endif // MIRACLE_QT_RECEIVECOINSDIALOG_H
