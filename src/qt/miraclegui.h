...
#ifndef MIRACLE_QT_MIRACLEGUI_H
#define MIRACLE_QT_MIRACLEGUI_H
...
/**
  Miracle GUI main class. This class represents the main window of the Miracle UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MiracleGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MiracleGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~MiracleGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a miracle wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
