...
#include "config/miracle-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMiracleURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MiracleUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMiracleURI(info));
}
