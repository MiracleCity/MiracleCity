...
#ifndef MIRACLE_QT_MIRACLEUNITS_H
#define MIRACLE_QT_MIRACLEUNITS_H
...
/** Miracle unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MiracleUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MiracleUnits(QObject *parent);

    /** Miracle units.
      @note Source: https://en.miracle.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MCAM,
...
typedef MiracleUnits::Unit MiracleUnit;

#endif // MIRACLE_QT_MIRACLEUNITS_H
