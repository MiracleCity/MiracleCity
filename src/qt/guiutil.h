...
#ifndef MIRACLE_QT_GUIUTIL_H
#define MIRACLE_QT_GUIUTIL_H
...
/** Utility functions used by the Miracle Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "miracle:" URI into recipient object, return true on successful parsing
