...
class BIP66Test(MiracleTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # miracled is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and miracled produces more specific reject
            # reasons.
