...
class AssetTest(MiracleTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("MIRACLE1", 1000)
        n0.issue("MIRACLE2", 1000)
        n0.issue("MIRACLE3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="MIRACLE*", verbose=False, count=2, start=-2)
        ...
        miracle_assets = n0.listassets(asset="MIRACLE*", verbose=False, count=2, start=-2)
        assert_equal(len(miracle_assets), 2)
        assert_equal(miracle_assets[0], "MIRACLE2")
        assert_equal(miracle_assets[1], "MIRACLE3")
        self.sync_all()
