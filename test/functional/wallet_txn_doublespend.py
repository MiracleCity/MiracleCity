...
class TxnMallTest(MiracleTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 MCAM:
        ...
        # First: use raw transaction API to send 1240 MCAM to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 MCAM coin each
        ...
        # Node0's balance should be starting balance, plus 50MCAM for another
        ...
        # Node0's total balance should be starting balance, plus 100MCAM for 
