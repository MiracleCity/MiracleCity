...
from test_framework.test_framework import MiracleTestFramework, SkipTest
...
class ZMQTest (MiracleTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that miracle has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("miracled has not been built with zmq enabled.")
