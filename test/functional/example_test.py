...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MiracleTestFramework
    pass

class ExampleTest(MiracleTestFramework):
    # Each functional test is a subclass of the MiracleTestFramework class.
    ...
    def custom_method(self):
        ...
        MiracleTestFramework class so other tests can use it."""
