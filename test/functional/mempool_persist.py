...
By default, miracled will dump mempool on shutdown and
...
class MempoolPersistTest(MiracleTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give miracled a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent miracled from writing mempool.dat to disk. Verify that `savemempool` fails")
