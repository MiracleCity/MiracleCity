...
# TestNode: A peer we use to send messages to miracled, and store responses.
...
class CompactBlocksTest(MiracleTestFramework):
    ...
    # This test actually causes miracled to (reasonably!) disconnect us, so do this last.
    ...
    # Test that miracled requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for miracled to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # miracled will not send blocktxn responses for blocks whose height is
