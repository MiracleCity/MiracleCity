...
class TestMiracleCli(MiracleTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `miracle-cli getinfo`")
        ...
        self.log.info("Compare responses from `miracle-cli -getinfo` and the RPCs data is retrieved from.")
